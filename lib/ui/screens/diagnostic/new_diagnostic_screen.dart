...
class NewDiagnosticScreen extends StatefulWidget {
  @override
  _NewDiagnosticScreenState createState() => _NewDiagnosticScreenState();
}
...
class _NewDiagnosticScreenState extends State<NewDiagnosticScreen> {
  ...
  String _title = DiagnosticScreenMessages.defaultDiagnosticTitleText;
  String _clientID = '';
  String _clientName = '';
  List _points = [];
  String _notes = '';
  DateTime _diagnosticDate = DateTime.now();

  String _warning;

  bool isLoading = false;
  bool isDiagnosticSettings = false;
  ...
  _buildDiagnosticScreenAppBar(
    ...
    return AppBar(
      ...
      title: AutoSizeText(
        DiagnosticScreenMessages.newDiagnosticTextTitle,
        maxLines: 2,
        style: TextStyle(
          fontSize: 16.0,
          color: Colors.white,
          ...
          onPressed: !isDiagnosticSettings
              ...
              : () async {
                  ...
                  try {
                    ...
                    await databaseService.addNewDiagnosticCard(_diagnosticCard);
                    setState(() {
                      isLoading = false;
                    });
                    Navigator.of(context).pop();
