...
import 'package:common_knowledge/ui/widgets/back_button_widget.dart';
...
class EditClientScreen extends StatefulWidget {
  ...
  EditClientScreen({this.currentClient});
...
class _EditClientScreenState extends State<EditClientScreen> {
  ...
  void initState() {
    ...
    _clientName = _currentClient.name;
    _clientEmail = _currentClient.email;
    _clientBirthDate = _currentClient.birthDate;
    _clientBirthPlace = _currentClient.birthPlace;
    _clientPhoneNumber = _currentClient.phoneNumber;
    _clientPhotoReference = _currentClient.photoReference;
//    print(_currentClient.id);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: AutoSizeText(
          SharedMessages.editInfoTextTitle,
          maxLines: 2,
          style: TextStyle(
            fontSize: 16.0,
            color: Colors.white,
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              keyboardType: TextInputType.text,
                              maxLines: 1,
                              initialValue: _clientBirthPlace,
                              decoration: kInputDecoration.copyWith(
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              keyboardType: TextInputType.text,
                              maxLines: 1,
                              initialValue: _clientPhoneNumber,
                              decoration: kInputDecoration.copyWith(
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              keyboardType: TextInputType.text,
                              maxLines: 1,
                              initialValue: _clientPhotoReference,
                              decoration: kInputDecoration.copyWith(
  ...
  Widget _saveClientButton() {
    return RaisedGradientButton(
      child: Text(
        ClientsScreenMessages.clientSaveButtonText,
        style: TextStyle(
          fontSize: 20,
          color: Colors.white,
        ),
      ...
      onPressed: () async {
        if (FormValidator.validate(_formKey.currentState)) {
          try {
            ...
            await _databaseService.editClientInfo(_currentClient.id, _client);
            setState(() {
              isLoading = false;
            });
            Navigator.of(context).pop();
